...
$sql="insert into tblorder(OrderNumber,UserID,FullName,ContactNumber,FlatNo,StreetName,Area,Landmark,City,Zipcode,State)values(:ordernumber,:userid,:fname,:cnumber,:fnaobno,:street,:area,:lndmark,:city,:zcode,:state)";
...
<div class="cart-total">
			 ...
			 <span class="total final"><?php echo "$ ".number_format($total_price, 2); ?></span>
			 <div class="clearfix"></div>
